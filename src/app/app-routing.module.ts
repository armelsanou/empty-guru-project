    ...
    children: [
      {
        ...
        loadChildren: () => import('./pages/gestion-domaines/gestion-domaines.module').then(m => m.GestionDomainesModule)
      }
    ]
  },
  {
    ...
    children: [
      {
        ...
        loadChildren: () => import('./pages/gestion-programmes/gestion-programmes.module').then(m => m.GestionProgrammesModule)
      }
    ]
  },
  {
    ...
    children: [
      {
        ...
        loadChildren: () => import('./pages/gestion-inscriptions/gestion-inscriptions.module').then(m => m.GestionInscriptionsModule)
      }
    ]
  }
];
