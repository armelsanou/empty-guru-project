...
export class HomeComponent implements OnInit {
    ...
    goToDomaine(){
        this.router.navigate(['gestion-domaines/blank-domaine']);
    }

    goToProgramme(){
        this.router.navigate(['gestion-programmes/blank-program']);
    }
    ...
    goToInscription(){
        this.router.navigate(['gestion-inscriptions/blank-inscription']);
    }
